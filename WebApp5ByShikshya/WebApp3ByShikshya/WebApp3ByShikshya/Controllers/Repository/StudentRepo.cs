...
using WebApp3ByShikshya.Models;

namespace WebApp3ByShikshya.Controllers.Repository
{
    public class StudentRepo
    {
        ...
        public List<Student> GetAllRecord()
        {
            ...
            try
            {
                ...
                //string conStr = @"server=DESKTOP-JAE0FTL\MSSQLSERVER01; database=ShikshyaDB; Trusted_Connection=True; TrustServerCertificate=True;";
                string conStr = @"server=SHIKSHYA\SQLEXPRESS; database=Shikshya; Trusted_Connection=True; TrustServerCertificate=True;";
